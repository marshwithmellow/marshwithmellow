  ...
  if (isWeiXinBrowser()) {
    $router.replace({ name: "home" }).then(() => {
      window.location.href =
        "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxa1c2983ad99da4bc&redirect_uri=https%3A%2F%2Fopenai-service.mbmzone.com%2Fapi%2FgetOpenidAuth&response_type=code&scope=snsapi_base&state=" +
        userInfo.value.id +
        "-" +
